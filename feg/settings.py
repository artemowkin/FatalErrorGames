...
WSGI_APPLICATION = 'feg.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': get_env('DJANGO_DATABASE_NAME', 'feg'),
        'USER': get_env('DJANGO_DATABASE_USER', 'django'),
        'PASSWORD': get_env('DJANGO_DATABASE_PASSWORD', 'django'),
        'HOST': 'localhost',
        'PORT': 5432,
    }
}
